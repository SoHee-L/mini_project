...
<%
	...
	System.out.println(purchaseVO+"updatepurchaseView쪽");
%>	
...
<form name="updatePurchase" method="post"	action="/updatePurchase.do?tranNo=10032">
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverName" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%= userVO.getUserName() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverPhone" class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%= userVO.getPhone() %>" />
		</td>
	</tr>
