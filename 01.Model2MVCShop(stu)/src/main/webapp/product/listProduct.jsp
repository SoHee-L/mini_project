...
<%
	HashMap<String,Object> map=(HashMap<String,Object>)request.getAttribute("map");  /* 세션은 오브젝트값으로 가져와서 값을 형변환 해준것. */
	SearchVO searchVO=(SearchVO)request.getAttribute("searchVO");
	String menu = request.getParameter("menu");
	System.out.println(menu+" :: listproduct실행~");
	...
	System.out.println("ioiojilkmjnio:"+list);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<%	
		...
		for(int i=0; i<list.size(); i++) {
			...
			System.out.println("fdfdfdfdfdd : " + vo);
	%>
	<%	
		UserVO userVO = (UserVO)session.getAttribute("user");
		System.out.println(userVO+"=listProduct.jsp userVO 실행");
	%>
