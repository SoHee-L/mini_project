...
<head>
	...
	<style>
       body > div.container{
        	border: 3px solid #f9dcdb;
            margin-top: 10px;
        }
        
       .bg-primary {color: #c98080;
    				background-color: #ffffff;} 
    				
    	.btn-info {background-image: linear-gradient(to bottom,#ecb0b0 0,#ffe5e5 100%);
    				background-repeat: repeat-x;
    				border-color: #d9a59a;}
    	
    	.form-control{border-color: #d9a59a;}
    	
    	.navbar-default .navbar-brand {color: #c98080;}	
    	
    	.btn-primary{background-repeat: repeat-x;
    				border-color: #d9a59a;
    				background-image: linear-gradient(to bottom,#ecb0b0 0,#ffe5e5 100%);}
    				
    	.btn-info:focus, .btn-info:hover {background-color: #fee4e4;
   											 background-position: 0 -15px;}
   											 
   		.btn-info.active, .btn-info:active {background-color: #eeb5b5;
    										border-color: #deb3ad;}
    										
    	.btn-primary:focus, .btn-primary:hover {background-color: #fee4e4;
    											background-position: 0 -15px;}	
    											
    	.btn-primary.active, .btn-primary:active {background-color: #eeb5b5;
    												border-color: #deb3ad;}																											 						
